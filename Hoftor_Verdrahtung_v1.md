...
Adern auf der oberen Reihe -O/-M, untere Reihe -U bleibt frei für die Tor-Adern.
...
`a` bleibt frei für die PSU-Zuleitung.
...
- [x] **Onboard-Relais-COMs CH1–CH6 ← +24 V (R-Block, rot):** CH1←R-c · CH2←R-e · CH3←R-g · CH4←R-i · CH5←R-k · CH6←R-m
- [x] **NO CH1–CH6 → A1 von R11–R16.** **Antriebsfarbe = Funktionsfarbe des Kanals** (durchgängig BFT→Waveshare; Schwarz = COM-Haupt, daher NICHT Antrieb): R11 **Grau** · R12 **Grün** · R13 **Weiß** · R14 **Gelb** · R15 **Rot** · R16 **Rot** (LEDs rot = +24-V-Antrieb ohne BFT-Funktionsfarbe).
- [x] K14 von R17→DI1 (**rot**), R18→DI2 (**rosa**), R19→DI3 (**weiß-schwarz**) — Funktionsfarbe durchgezogen
- [x] ESP DI-COM → GND: **Bl-c → COM** (Blau), **DGND frei** (isolierter Eingangs-COM auf 24-V-GND; DGND = Logik-Masse, bleibt unbeschaltet). Opto-Eingänge bidirektional → Polarität unkritisch.
